...
There are two ways to install Libretime: from a release or from source. We recommend you install from source since Libretime is under active development.

Open a terminal on your server and enter the following commands:

<Tabs>
  <TabItem value="release" label="Release">
    <CodeBlock language="bash">
      wget https://github.com/LibreTime/libretime/releases/download/{globals.version}/libretime-{globals.version}.tar.gz
      <br />
      tar -xzf libretime-{globals.version}.tar.gz
      <br />
      cd libretime-{globals.version}
      <br />
